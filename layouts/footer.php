<footer style="background-color: #81d742 !important;">
		...
		<div class="row">
			<div class="col-md-4">
				...
				<ul>
					...
					<li><i class="bi bi-mailbox2"></i> hao@gmail.com</li>
	...
	<div style="background-color: #3f9609; width: 100%; text-align: center; padding: 20px;">
		© 2022 Zic Zac Group . Được thiết kế bời Nhom_03. All rights reserved.
	</div>
</footer>
<!-- back to top -->
